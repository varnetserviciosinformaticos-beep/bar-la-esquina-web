      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground">
            Ven a <span className="text-gradient-gold italic">visitarnos</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1">
                  <p>Martes - Jueves: 18:00 - 01:00</p>
                  <p>Viernes - Sábado: 18:00 - 03:00</p>
                  <p>Domingo: 17:00 - 00:00</p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Button
                variant="elegant"
                onClick={() => window.open("https://instagram.com/barlaesquina", "_blank")}
              >
                <Instagram size={18} />
                Instagram
              </Button>
          ...
          <div className="relative">
            <div className="aspect-square rounded-xl overflow-hidden border border-border shadow-elegant">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3037.4687529706766!2d-3.6879099!3d40.4189933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd42289c5b5f8a3f%3A0x4b3e1c5f4f6e4b5!2sMadrid%2C%20Spain!5e0!3m2!1sen!2sus!4v1699999999999!5m2!1sen!2sus"
                width="100%"
                height="100%"
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-card/90 backdrop-blur-sm rounded-lg p-4 border border-border">
              <p className="font-serif text-foreground">Bar La Esquina</p>
              <p className="text-sm text-muted-foreground">Calle de la Esquina, 42 · Madrid</p>
            </div>
          </div>
        </div>
      </div>
